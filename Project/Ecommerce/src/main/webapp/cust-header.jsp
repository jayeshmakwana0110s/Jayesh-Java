            ...
            <ul class="navbar-nav mb-2 mb-lg-0">
              ...
              <li class="nav-item px-3 py-1 py-lg-0 dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end animate slide mt-3 border-0 shadow">
                  <li><a href="searchproduct.jsp" class="dropdown-item">Search Product </a>
                  </li>
              ...
              <li class="nav-item px-3 py-1 py-lg-0">
               ...
               <li class="nav-item px-3 py-1 py-lg-0 dropdown">
                <a class="nav-link p-0 dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button"
                  aria-expanded="false"><b>Welcome, <%=session.getAttribute("firstname") %> <%=session.getAttribute("lastname") %></b><svg width="20" height="20" style="vertical-align: sub;">
                    <use xlink:href="#arrow-down"></use>
                  </svg></a>
                <ul class="dropdown-menu dropdown-menu-end animate slide mt-3 border-0 shadow">
                  <li><a href="cviewprofile.jsp" class="dropdown-item">View Profile </a>
                  </li>
                  <li><a href="clogout.jsp" class="dropdown-item">Logout </a>
                  </li>
