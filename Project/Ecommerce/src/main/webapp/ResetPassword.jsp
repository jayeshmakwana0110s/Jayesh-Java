...
<body>
  ...
  <section id="quote" class="padding-small">
    <div class="container text-center">
      <h3 class="display-6 fw-semibold mb-4">Customer ResetPassword</h3>
      <form method="post" action="ForgotController" class="contact-form row mt-5">
        
       
       <div class="col-md-12 col-sm-12 mb-4">
          <input type="password" name="newpassword" placeholder="Password*" class="form-control w-100 ps-3 py-2 rounded-0" required>
        </div>
        <div class="col-md-12 col-sm-12 mb-4">
          <input type="password" name="Cpassword" placeholder="Confirm Password*" class="form-control w-100 ps-3 py-2 rounded-0" required>
        </div>
        <div class="col-12">
        <button type="submit" name="action" value="confirm" class="btn btn-primary btn-slide hover-slide-right mt-4">
             <span>Confirm</span>
         </button>
