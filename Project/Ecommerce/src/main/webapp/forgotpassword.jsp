...
<body>
  ...
  <section id="quote" class="padding-small">
    <div class="container text-center">
      <h3 class="display-6 fw-semibold mb-4">Customer ForgotPasswrod</h3>
      <form method="post" action="ForgotController" class="contact-form row mt-5">
        ...
        <div class="col-12">
        <button type="submit" name="action" value="submit" class="btn btn-primary btn-slide hover-slide-right mt-4">
             <span>Submit</span>
         </button>
