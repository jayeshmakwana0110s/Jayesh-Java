...
function searchInfo()
{  
	var name=document.vinform.productname.value;  
...
<body>
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <div class="container text-center">
      <h3 class="display-6 fw-semibold mb-4">Customer Search Product</h3>
      <form method="post" name="vinform" class="contact-form row mt-5">
        
        <div class="col-md-12 col-sm-12 mb-4">
          <input type="text" name="productname" placeholder="Search Product like s23, v11" required onkeyup="searchInfo()" >
        </div>
