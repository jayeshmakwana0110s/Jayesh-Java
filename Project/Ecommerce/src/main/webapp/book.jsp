...
<body>
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
	...
	<%
		...
		int subproductid=Integer.parseInt(request.getParameter("subproductid"));
		int price=Integer.parseInt(request.getParameter("price"));
		String subproductname=new CustomerDao().getSubProductName(subproductid);
	%>
	
	
  <section id="quote" class="padding-small">
    <div class="container text-center">
      <h3 class="display-6 fw-semibold mb-4">Book Details</h3>
      <form method="post" action="CustomerController" class="contact-form row mt-5">
        <div class="col-lg-6 col-md-12 col-sm-12 mb-4">
          <input type="text" name="firstname" placeholder="First Name*" value="<%=model.getFirstname() %>" class="form-control w-100 ps-3 py-2 rounded-0"
            required>
        </div>
        <div class="col-lg-6 col-md-12 col-sm-12 mb-4">
          <input type="text" name="lastname" placeholder="Last Name*" value="<%=model.getLastname() %>" class="form-control w-100 ps-3 py-2 rounded-0"
            required>
        </div>
        
        <div class="col-md-12 col-sm-12 mb-4">
          <textarea class="form-control w-100 ps-3 py-2 rounded-0" rows="5" type="text" name="address"
            placeholder="Address"><%=model.getAddress() %></textarea>
        </div>
        
        <div class="col-lg-6 col-md-12 col-sm-12 mb-4">
          <input type="text" name="city" placeholder="City*" value="<%=model.getCity() %>" class="form-control w-100 ps-3 py-2 rounded-0"
            required>
        </div>
        
        <div class="col-lg-6 col-md-12 col-sm-12 mb-4">
          <input type="text" name="pincode" placeholder="PinCode*" value="<%=model.getPincode() %>" class="form-control w-100 ps-3 py-2 rounded-0"
            required>
        </div>
        
        <div class="col-md-12 col-sm-12 mb-4">
          <input type="text" name="mobno" placeholder="Mobile No*" value="<%=model.getMobno() %>" class="form-control w-100 ps-3 py-2 rounded-0"
            required>
        </div>
       
        <div class="col-md-12 col-sm-12 mb-4">
          <input type="text" name="subproductname" value="<%=subproductname %>" class="form-control w-100 ps-3 py-2 rounded-0"
            required>
        </div>
        <div class="col-md-12 col-sm-12 mb-4">
          <input type="text" name="totalprice" placeholder="totalprice" value="<%=price %>" class="form-control w-100 ps-3 py-2 rounded-0"
            required>
        ...
        <div class="col-12">
        <button type="submit" name="action" value="book" class="btn btn-primary btn-slide hover-slide-right mt-4">
             <span>Book</span>
         </button>
         <button type="submit" name="action" value="cancle" class="btn btn-primary btn-slide hover-slide-right mt-4">
             <span>Cancle</span>
         </button>
        </div>
      </form>
