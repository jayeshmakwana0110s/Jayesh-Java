  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <div class="container">
      <div class="d-flex justify-content-between align-items-center">
        <div>
          <h6><span class="text-primary">|</span>Sub Product</h6>
          <h3 class="display-6 fw-semibold">View Sub Product</h3>
        </div>
      ...
      <div class="row mt-5">
       <%
            ...
            String qry="select * from subproduct where productid=?";
          ...
          <div class="card-item">
            <div class="card border-0 bg-transparent">
              <div class="card-image position-relative">
                <a href="index.html"><img src="productimage/<%=rs.getString(6) %>" alt="post-img" class="post-image img-fluid" width="250px" height="250px"></a>
              </div>
            </div>
            <div class="card-body p-0 mt-2">
              <span class="text-capitalize text-black-50"><%=rs.getString(3) %></span>
              <a href="index.html">
              		<b><%=rs.getString(5) %></b>
              </a>
              <p>Features : <%=rs.getString(4) %> <span><a href="book.jsp?subproductid=<%=rs.getInt(1) %>&price=<%=rs.getString(5) %>" class="text-decoration-underline fst-italic">Book Product</a></span> </p>
            </div>
          </div>
        </div>
        <%
