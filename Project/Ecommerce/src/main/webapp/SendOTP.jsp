...
%>
  ...
  <section id="quote" class="padding-small">
    <div class="container text-center">
      <h3 class="display-6 fw-semibold mb-4">Customer OTP Page</h3>
      <form method="post" action="ForgotController" class="contact-form row mt-5">
         <label>Otp Sent on this email : <%=email %></label><br>
        <div class="col-md-12 col-sm-12 mb-4">
          <input type="text" name="EnterOTP" placeholder="Enter OTP" class="form-control w-100 ps-3 py-2 rounded-0" required>
        </div>
       
        <div class="col-12">
        <button type="submit" name="action" value="verify" class="btn btn-primary btn-slide hover-slide-right mt-4">
             <span>Verify</span>
         </button>
