...
<body>
  ...
  <section id="quote" class="padding-small">
    <div class="container text-center">
      <h3 class="display-6 fw-semibold mb-4">Customer Registration</h3>
      <form method="post" action="CustomerController" class="contact-form row mt-5">
        <div class="col-lg-6 col-md-12 col-sm-12 mb-4">
          <input type="text" name="firstname" placeholder="First Name*" class="form-control w-100 ps-3 py-2 rounded-0"
            required>
        </div>
        <div class="col-lg-6 col-md-12 col-sm-12 mb-4">
          <input type="text" name="lastname" placeholder="Last Name*" class="form-control w-100 ps-3 py-2 rounded-0"
            required>
        </div>
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 mb-4">
          <input type="text" name="city" placeholder="City*" class="form-control w-100 ps-3 py-2 rounded-0"
            required>
        </div>
        
        <div class="col-lg-6 col-md-12 col-sm-12 mb-4">
          <input type="text" name="pincode" placeholder="PinCode*" class="form-control w-100 ps-3 py-2 rounded-0"
            required>
        </div>
        
        <div class="col-md-12 col-sm-12 mb-4">
          <input type="text" name="mobno" placeholder="Mobile No*" class="form-control w-100 ps-3 py-2 rounded-0"
            required>
        </div>
        <div class="col-md-12 col-sm-12 mb-4">
       ...
       <div class="col-md-12 col-sm-12 mb-4">
          <input type="password" name="password" placeholder="Password*" class="form-control w-100 ps-3 py-2 rounded-0" required>
        </div>
        <div class="col-12">
        <button type="submit" name="action" value="registration" class="btn btn-primary btn-slide hover-slide-right mt-4">
