...
<body>
  ...
  <section id="quote" class="padding-small">
    <div class="container text-center">
      <h3 class="display-6 fw-semibold mb-4">Customer Login</h3>
      <form method="post" action="CustomerController" class="contact-form row mt-5">
       ...
       <div class="col-md-12 col-sm-12 mb-4">
        ...
        <div class="col-12">
        <button type="submit" name="action" value="login" class="btn btn-primary btn-slide hover-slide-right mt-4">
             <span>Login</span>
         </button>
