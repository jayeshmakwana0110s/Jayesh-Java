  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <div class="container">
      <div class="d-flex justify-content-between align-items-center">
        <div>
          <h6><span class="text-primary">|</span>Product</h6>
          <h3 class="display-6 fw-semibold">View Main Product</h3>
        </div>
          ...
          <div class="card-item">
            <div class="card border-0 bg-transparent">
              <div class="card-image position-relative">
                <a href="index.html"><img src="productimage/<%=rs.getString(4) %>" alt="post-img" class="post-image img-fluid" width="250px" height="250px"></a>
              </div>
            </div>
            <div class="card-body p-0 mt-2">
              ...
              <p>Elit adipi massa diam in dignissim. Sagittis pulvinar ut dis venenatis nunc nunc vitae aliquam
                vestibulum... <span><a href="viewsubproduct.jsp?productid=<%=rs.getInt(1) %>" class="text-decoration-underline fst-italic">View SubProduct</a></span> </p>
            </div>
          </div>
        </div>
        <%
