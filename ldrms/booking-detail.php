...
<?php if($book!=TRUE){?>
    <td><button class="btn"  value=<?php echo $total;?>id="submit" type="submit" name="makepayment">Pay-Now <?php echo $total; ?></button></td>
</form>
<?php } ?>
...
function paynow(){
    ...
    // var d1 = <?php echo $row['ddf']; ?>;
    // var rpice = <?php echo $rpice; ?>;
    // var qty = <?php echo $qty; ?>;
    // var total = d1 * rpice * qty;
    
    // // Update the content of the <td> tag
    // document.getElementById("tc").textContent = "Rs. " + total;
  }
</script>